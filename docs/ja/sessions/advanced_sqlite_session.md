...
- **メッセージ構造のメタデータ**: メッセージ種別、ツール使用、会話フローを追跡
...
すべての機能を包括的に示す [complete example](https://github.com/openai/openai-agents-python/tree/main/examples/memory/advanced_sqlite_session_example.py) をご覧ください。
