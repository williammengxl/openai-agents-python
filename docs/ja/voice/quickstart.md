...
Agents SDK の基本的な [クイックスタートの手順](../quickstart.md) に従い、仮想環境をセットアップしてください。次に、この SDK から任意の音声関連の依存関係をインストールします:
...
まずはエージェントをいくつか用意します。これは、この SDK でエージェントを作成したことがある方にはおなじみのはずです。ここでは、複数のエージェント、ハンドオフ、そしてツールを用意します。
