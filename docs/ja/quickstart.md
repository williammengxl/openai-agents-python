...
各エージェントで、タスクを進める方法を決めるために選択可能な、発信側のハンドオフ オプションの在庫を定義できます。
...
エージェントの実行中に何が起きたかを確認するには、OpenAI ダッシュボードの Trace viewer に移動し、エージェント実行のトレースを表示してください。(https://platform.openai.com/traces)
